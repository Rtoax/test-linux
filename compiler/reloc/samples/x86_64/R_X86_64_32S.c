...
static long __unused sli = 1;
static long __unused *psl;
...
int main(void)
{
	 ...
	 */
	const char __unused *s1 = RODATA_1;
	const char __unused *s2 = RODATA_1;
	 ...
	 */
	const long __unused *pl1 = &gcl1;
	const long __unused *pl2 = &gcl2;
