...
#define LAYOUT_FN_A		lib_layout_A_
#define LAYOUT_FN_B		lib_layout_B_
#define LAYOUT_FN_C		lib_layout_C
#define LAYOUT_FN_D		lib_layout_D_
#define LAYOUT_FN_E		lib_layout_E
#define LAYOUT_FN_F		lib_layout_F_
#define LAYOUT_FN_G		lib_layout_G
#define LAYOUT_FN_H		lib_layout_H_
#define LAYOUT_FN_I		lib_layout_I
#define LAYOUT_FN_J		lib_layout_J_
#include "layout.h"
