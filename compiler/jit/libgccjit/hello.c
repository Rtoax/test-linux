/**
 * ref: https://gcc.gnu.org/onlinedocs/jit/intro/tutorial01.html
 */
#include <libgccjit.h>
#include <stdlib.h>
#include <stdio.h>
...
*/
	...
	gcc_jit_function *printf_func = gcc_jit_context_new_function(ctxt, NULL,
	...
	gcc_jit_block_add_eval(block, NULL, gcc_jit_context_new_call(ctxt,
								NULL,
								printf_func,
								2, args));
