...
If it is just a CUDA program, it is a good choice to use llvm to compile the PTX intermediate expression into the machine code of the target hardware, such as `ZLUDA <https://github.com/vosen/ZLUDA>`_.
