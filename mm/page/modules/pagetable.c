...
static ssize_t pid_read(struct file *filp, char *buf, size_t len,
			loff_t *offset)
{
...
static ssize_t pid_write(struct file *filp, const char *buf, size_t len,
			 loff_t *off)
{
...
static void dump_pte(struct seq_file *m, struct mm_struct *mm_pt, u64 idx,
		     u64 mask, void *table)
{
	/* PTE entry
	 * Intel Vol. 3A 4-27
...
static void dump_pmd(struct seq_file *m, struct mm_struct *mm_pt, u64 idx,
		     void *table)
{
	/* PMD(PDe)
	 * Intel 4-26 Vol. 3A
...
static void dump_pud(struct seq_file *m, struct mm_struct *mm_pt, u64 idx,
		     void *table)
{
	/* PUD(PDPTe)
	 * Intel Vol. 3A 4-25
...
static void dump_pgd(struct seq_file *m, struct mm_struct *mm_pt, u64 idx,
		     void *table)
{
	/* PGD(PML4E) entries
	 * Intel Vol. 3A 4-23
