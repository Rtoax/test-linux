...
target-cpp-${CC_SUPPORT_STD_C++20} += format
target-cpp-y += __STDC__
target-cpp-y += __STDC__c++98 __STDC__gnu++98
target-cpp-${CC_SUPPORT_STD_C++03} += __STDC__c++03 __STDC__gnu++03
target-cpp-${CC_SUPPORT_STD_C++11} += __STDC__c++11 __STDC__gnu++11
target-cpp-${CC_SUPPORT_STD_C++14} += __STDC__c++14 __STDC__gnu++14
target-cpp-${CC_SUPPORT_STD_C++17} += __STDC__c++17 __STDC__gnu++17
target-cpp-${CC_SUPPORT_STD_C++20} += __STDC__c++20 __STDC__gnu++20
target-cpp-${CC_SUPPORT_STD_C++23} += __STDC__c++23 __STDC__gnu++23
target-cpp-${CC_SUPPORT_STD_C++26} += __STDC__c++26 __STDC__gnu++26
