...
$(call make_append_var_to_file,CC_STD_C11,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU11,${cachefile})
$(call make_append_var_to_file,CC_STD_C17,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU17,${cachefile})
$(call make_append_var_to_file,CC_STD_C23,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU23,${cachefile})
$(call make_append_var_to_file,CC_STD_C26,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU26,${cachefile})

$(call make_append_var_to_file,CC_STD_GNU++11,${cachefile})
$(call make_append_var_to_file,CC_STD_C++11,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU++14,${cachefile})
$(call make_append_var_to_file,CC_STD_C++14,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU++17,${cachefile})
$(call make_append_var_to_file,CC_STD_C++17,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU++03,${cachefile})
$(call make_append_var_to_file,CC_STD_C++03,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU++20,${cachefile})
$(call make_append_var_to_file,CC_STD_C++20,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU++23,${cachefile})
$(call make_append_var_to_file,CC_STD_C++23,${cachefile})
$(call make_append_var_to_file,CC_STD_GNU++26,${cachefile})
$(call make_append_var_to_file,CC_STD_C++26,${cachefile})
