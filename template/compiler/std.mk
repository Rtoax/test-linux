...
CC_STD_C11 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c11))
CC_STD_GNU11 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu11))
CC_STD_C17 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c17))
CC_STD_GNU17 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu17))
CC_STD_C23 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c23))
CC_STD_GNU23 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu23))
CC_STD_C26 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c26))
CC_STD_GNU26 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu26))

CC_STD_GNU++11 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu++11))
CC_STD_C++11 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c++11))
CC_STD_GNU++14 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu++14))
CC_STD_C++14 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c++14))
CC_STD_GNU++17 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu++17))
CC_STD_C++17 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c++17))
CC_STD_GNU++03 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu++03))
CC_STD_C++03 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c++03))
CC_STD_GNU++20 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu++20))
CC_STD_C++20 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c++20))
CC_STD_GNU++23 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu++23))
CC_STD_C++23 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c++23))
CC_STD_GNU++26 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=gnu++26))
CC_STD_C++26 := $(findstring y,$(call check_compiler_option_S,$(CC),-std=c++26))
