...
CC_STD_C23 := $(findstring y,$(call check_compiler_option,$(CC),-std=c23))
CC_STD_GNU23 := $(findstring y,$(call check_compiler_option,$(CC),-std=gnu23))
CC_STD_C26 := $(findstring y,$(call check_compiler_option,$(CC),-std=c26))
CC_STD_GNU26 := $(findstring y,$(call check_compiler_option,$(CC),-std=gnu26))

CC_STD_GNU++11 := $(findstring y,$(call check_compiler_option,$(CC),-std=gnu++11))
CC_STD_C++11 := $(findstring y,$(call check_compiler_option,$(CC),-std=c++11))
CC_STD_GNU++14 := $(findstring y,$(call check_compiler_option,$(CC),-std=gnu++14))
CC_STD_C++14 := $(findstring y,$(call check_compiler_option,$(CC),-std=c++14))
CC_STD_GNU++17 := $(findstring y,$(call check_compiler_option,$(CC),-std=gnu++17))
CC_STD_C++17 := $(findstring y,$(call check_compiler_option,$(CC),-std=c++17))
CC_STD_GNU++03 := $(findstring y,$(call check_compiler_option,$(CC),-std=gnu++03))
CC_STD_C++03 := $(findstring y,$(call check_compiler_option,$(CC),-std=c++03))
