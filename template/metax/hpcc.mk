...
HPCC_MAJOR := $(shell echo ${HPCC_VERSION_RAW} | awk -F '.' '{print $$1}')
HPCC_MINOR := $(shell echo ${HPCC_VERSION_RAW} | awk -F '.' '{print $$2}')
HPCC_PATCH := $(shell echo ${HPCC_VERSION_RAW} | awk -F '.' '{print $$3}')
...
export HPCC_LLVM
export HTCC
export HPCC_MAJOR HPCC_MINOR HPCC_PATCH
...
ifdef DEBUG
  ...
  $(info HPCC_MAJOR = ${HPCC_MAJOR})
  $(info HPCC_MINOR = ${HPCC_MINOR})
  $(info HPCC_PATCH = ${HPCC_PATCH})
endif
