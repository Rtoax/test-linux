...
@echo >&2 -e "$(1)             ${BB}888888888888888888${RST}"
@echo >&2 -e "$(1)             ${BB}88'${RST} _${BB}'88'${RST}_  ${BB}'88888${RST}"
@echo >&2 -e "$(1)             ${BB}88${RST} 88 ${BB}88${RST} 88  ${BB}88888${RST}"
@echo >&2 -e "$(1)             ${BB}88_${RST}88${BB}_::_${RST}88${BB}_:88888${RST}"
@echo >&2 -e "$(1)             ${BB}88${RST}${RB}:::,::,:::::${RST}${BB}8888${RST}"
@echo >&2 -e "$(1)             ${BB}88${RST}${RB}':::::::::''${RST}${BB}8888${RST}"
@echo >&2 -e "$(1)            ${BB}.88${RST}  ${RB}'::::'${RST}    ${BB}8:88.${RST}"
@echo >&2 -e "$(1)           ${BB}8888${RST}            ${BB}'8:888.${RST}"
@echo >&2 -e "$(1)         ${BB}.8888'${RST}             ${BB}'888888.${RST}"
@echo >&2 -e "$(1)        ${BB}.8888:${RST}..  .::.  ...${BB}:'8888888:.${RST}"
@echo >&2 -e "$(1)       ${BB}.8888.'${RST}     :'     ''::${BB}'88:88888${RST}"
@echo >&2 -e "$(1)      ${BB}.8888${RST}        '         ${BB}'.888:8888.${RST}"
@echo >&2 -e "$(1)     ${BB}888:8${RST}         .           ${BB}888:88888${RST}"
@echo >&2 -e "$(1)   ${BB}.888:88${RST}        .:           ${BB}888:88888:${RST}"
@echo >&2 -e "$(1)   ${BB}8888888.${RST}       ::           ${BB}88:888888${RST}"
@echo >&2 -e "$(1)   ${BB}'${RST}${YB}.::.${RST}${BB}888.${RST}      ::          ${BB}.88888888${RST}"
@echo >&2 -e "$(1)  ${YB}.::::::.${RST}${BB}888.${RST}    ::         ${YB}:::${RST}${BB}'8888'${RST}${YB}.:.${RST}"
@echo >&2 -e "$(1) ${YB}::::::::::.${RST}${BB}888${RST}   '         ${YB}.::::::::::::${RST}"
@echo >&2 -e "$(1) ${YB}::::::::::::.${RST}${BB}8${RST}    '      ${BB}.:8${RST}${YB}::::::::::::.${RST}"
@echo >&2 -e "$(1)${YB}.::::::::::::::.${RST}        ${BB}.:888${RST}${YB}:::::::::::::${RST}"
@echo >&2 -e "$(1)${YB}:::::::::::::::${RST}${BB}88:.__..:88888${RST}${YB}:::::::::::'${RST}"
@echo >&2 -e "$(1) ${YB}''.:::::::::::${RST}${BB}88888888888.88${RST}${YB}:::::::::'${RST}"
@echo >&2 -e "$(1)       ${YB}'':::_:'${RST}${BB} -- '' -'-' ''${RST}${YB}:_::::''${RST}"
endef
