...
$(if $(target-nvcc-y)$(target-nvcc-libso-y)$(target-liba-y), $(eval include targets/cuda.mk))
$(if $(target-hipcc-y)$(target-hipcc-libso-y)$(target-liba-y), $(eval include targets/hip.mk))
$(if $(target-htcc-y)$(target-htcc-libso-y)$(target-liba-y), $(eval include targets/hpcc.mk))
$(if $(target-lscc-y)$(target-lscc-libso-y)$(target-liba-y), $(eval include targets/luca.mk))
$(if $(shell-y), $(eval include targets/shell.mk))
$(if $(prog-y), $(eval include targets/prog.mk))
$(if $(make-y), $(eval include targets/make.mk))
$(if $(bpftrace-y), $(eval include targets/bpftrace.mk))
