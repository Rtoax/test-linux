...
# - HAVE_LINGSPEED_X718=[y|n]
# - HAVE_LINGSPEED_X721E=[y|n]
# - HAVE_LINGSPEED_X721M=[y|n]
# - HAVE_LINGSPEED_X721P=[y|n]
#
...
X718_PCI_DEVICE_ID := 7180
X721E_PCI_DEVICE_ID := 7211
X721M_PCI_DEVICE_ID := 7213
X721P_PCI_DEVICE_ID := 7214

HAVE_LINGSPEED_GPU := n
HAVE_LINGSPEED_X710E := n
HAVE_LINGSPEED_X710M := n
HAVE_LINGSPEED_X710P := n
HAVE_LINGSPEED_X718 := n
HAVE_LINGSPEED_X721E := n
HAVE_LINGSPEED_X721M := n
HAVE_LINGSPEED_X721P := n
...
ifneq ($(shell lspci -d ${CESTC_PCI_VENDOR_ID}:${X718_PCI_DEVICE_ID}),)
  export HAVE_LINGSPEED_X718 := y
  export HAVE_LINGSPEED_GPU := y
endif

ifneq ($(shell lspci -d ${CESTC_PCI_VENDOR_ID}:${X721E_PCI_DEVICE_ID}),)
  export HAVE_LINGSPEED_X721E := y
  export HAVE_LINGSPEED_GPU := y
endif

ifneq ($(shell lspci -d ${CESTC_PCI_VENDOR_ID}:${X721M_PCI_DEVICE_ID}),)
  export HAVE_LINGSPEED_X721M := y
  export HAVE_LINGSPEED_GPU := y
endif

ifneq ($(shell lspci -d ${CESTC_PCI_VENDOR_ID}:${X721P_PCI_DEVICE_ID}),)
  export HAVE_LINGSPEED_X721P := y
  export HAVE_LINGSPEED_GPU := y
endif
...
ifdef DEBUG
  ...
  $(info HAVE_LINGSPEED_X718 = ${HAVE_LINGSPEED_X718})
  $(info HAVE_LINGSPEED_X721E = ${HAVE_LINGSPEED_X721E})
  $(info HAVE_LINGSPEED_X721M = ${HAVE_LINGSPEED_X721M})
  $(info HAVE_LINGSPEED_X721P = ${HAVE_LINGSPEED_X721P})
endif
