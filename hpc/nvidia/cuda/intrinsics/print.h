...
#define PFP8x2E8M0(v)                                    \
	do {                                             \
		__nv_bfloat162_raw ___bf162raw =         \
			__nv_cvt_e8m0x2_to_bf162raw(v);  \
		PPFX();                                  \
		printf("E8M0: %s : {%f, %f}\n", #v,      \
		       __bfloat162float(___bf162raw.x),  \
		       __bfloat162float(___bf162raw.y)); \
	} while (0)
...
#define PFP8x2E4M3(v)                                                         \
	do {                                                                  \
		__half2_raw ___h2raw =                                        \
			__nv_cvt_fp8x2_to_halfraw2(v, __NV_E4M3);             \
		PPFX();                                                       \
		printf("E4M3: %s : {%f, %f}\n", #v, __half2float(___h2raw.x), \
		       __half2float(___h2raw.y));                             \
	} while (0)
...
#define __PBF162(type, v)                                                  \
	do {                                                               \
		type __bf162 = v;                                          \
		PPFX();                                                    \
		printf("%s : {%f, %f}\n", #v, __bfloat162float(__bf162.x), \
		       __bfloat162float(__bf162.y));                       \
	} while (0)
