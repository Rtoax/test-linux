...
#define CUBLAS_GEMM_ALGO0_TENSOR_OP	HCBLAS_GEMM_ALGO0_TENSOR_OP
#define CUBLAS_GEMM_ALGO1_TENSOR_OP	HCBLAS_GEMM_ALGO1_TENSOR_OP
#define CUBLAS_GEMM_ALGO2_TENSOR_OP	HCBLAS_GEMM_ALGO2_TENSOR_OP
#define CUBLAS_GEMM_ALGO3_TENSOR_OP	HCBLAS_GEMM_ALGO3_TENSOR_OP
#define CUBLAS_GEMM_ALGO4_TENSOR_OP	HCBLAS_GEMM_ALGO4_TENSOR_OP
#define CUBLAS_GEMM_ALGO5_TENSOR_OP	HCBLAS_GEMM_ALGO5_TENSOR_OP
#define CUBLAS_GEMM_ALGO6_TENSOR_OP	HCBLAS_GEMM_ALGO6_TENSOR_OP
#define CUBLAS_GEMM_ALGO7_TENSOR_OP	HCBLAS_GEMM_ALGO7_TENSOR_OP
#define CUBLAS_GEMM_ALGO8_TENSOR_OP	HCBLAS_GEMM_ALGO8_TENSOR_OP
#define CUBLAS_GEMM_ALGO9_TENSOR_OP	HCBLAS_GEMM_ALGO9_TENSOR_OP
#define CUBLAS_GEMM_ALGO10_TENSOR_OP	HCBLAS_GEMM_ALGO10_TENSOR_OP
#define CUBLAS_GEMM_ALGO11_TENSOR_OP	HCBLAS_GEMM_ALGO11_TENSOR_OP
#define CUBLAS_GEMM_ALGO12_TENSOR_OP	HCBLAS_GEMM_ALGO12_TENSOR_OP
#define CUBLAS_GEMM_ALGO13_TENSOR_OP	HCBLAS_GEMM_ALGO13_TENSOR_OP
#define CUBLAS_GEMM_ALGO14_TENSOR_OP	HCBLAS_GEMM_ALGO14_TENSOR_OP
#define CUBLAS_GEMM_ALGO15_TENSOR_OP	HCBLAS_GEMM_ALGO15_TENSOR_OP
#define CUBLAS_GEMM_AUTOTUNE	HCBLAS_GEMM_AUTOTUNE
 ...
 */
#define curandStatus_t	hcrandStatus_t
#define CURAND_STATUS_SUCCESS	HCRAND_STATUS_SUCCESS
#define CURAND_STATUS_SUCCESS	HCRAND_STATUS_SUCCESS
#define CURAND_STATUS_VERSION_MISMATCH	HCRAND_STATUS_VERSION_MISMATCH
#define CURAND_STATUS_NOT_INITIALIZED	HCRAND_STATUS_NOT_INITIALIZED
#define CURAND_STATUS_ALLOCATION_FAILED	HCRAND_STATUS_ALLOCATION_FAILED
#define CURAND_STATUS_TYPE_ERROR	HCRAND_STATUS_TYPE_ERROR
#define CURAND_STATUS_OUT_OF_RANGE	HCRAND_STATUS_OUT_OF_RANGE
#define CURAND_STATUS_LENGTH_NOT_MULTIPLE	HCRAND_STATUS_LENGTH_NOT_MULTIPLE
#define CURAND_STATUS_DOUBLE_PRECISION_REQUIRED	HCRAND_STATUS_DOUBLE_PRECISION_REQUIRED
#define CURAND_STATUS_LAUNCH_FAILURE	HCRAND_STATUS_LAUNCH_FAILURE
#define CURAND_STATUS_PREEXISTING_FAILURE	HCRAND_STATUS_PREEXISTING_FAILURE
#define CURAND_STATUS_INITIALIZATION_FAILED	HCRAND_STATUS_INITIALIZATION_FAILED
#define CURAND_STATUS_ARCH_MISMATCH	HCRAND_STATUS_ARCH_MISMATCH
#define CURAND_STATUS_INTERNAL_ERROR	HCRAND_STATUS_INTERNAL_ERROR
#define CURAND_STATUS_NOT_IMPLEMENTED	HCRAND_STATUS_NOT_IMPLEMENTED
