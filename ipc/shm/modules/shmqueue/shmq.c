 ...
 *
 * 2019.09.30	Rong Tao	Create
 * 2019.10.08	Rong Tao	Read Write lock
 * 2024-02-27	Rong Tao	Format code
 */
...
static ssize_t shmq_write(struct file *file, const char __user *buf,
...
static ssize_t shmq_read(struct file *file, char __user *buf, size_t count,
			 loff_t *ppos)
{
	shmq_debug(__SHMQ_DEV_NAME"\n");
